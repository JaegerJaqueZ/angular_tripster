(function () {
  'use strict';
  angular.module('tripsterApp').directive('leaflet', [
    '$q',
    'leafletData',
    'leafletMapDefaults',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('center', [
    '$log',
    '$q',
    '$location',
    'leafletMapDefaults',
  ...
  angular.module('tripsterApp').directive('tiles', [
    '$log',
    'leafletData',
    'leafletMapDefaults',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('legend', [
    '$log',
    '$http',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('geojson', [
    '$log',
    '$rootScope',
    'leafletData',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('layers', [
    '$log',
    '$q',
    'leafletData',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('bounds', [
    '$log',
    '$timeout',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('markers', [
    '$log',
    '$rootScope',
    '$q',
    'leafletData',
  ...
  angular.module('tripsterApp').directive('paths', [
    '$log',
    'leafletData',
    'leafletMapDefaults',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('controls', [
    '$log',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').directive('eventBroadcast', [
    '$log',
    '$rootScope',
    'leafletHelpers',
    'leafletEvents',
  ...
  angular.module('tripsterApp').directive('maxbounds', [
    '$log',
    'leafletMapDefaults',
    'leafletBoundsHelpers',
  ...
  angular.module('tripsterApp').service('leafletData', [
    '$log',
    '$q',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').factory('leafletMapDefaults', [
    '$q',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').factory('leafletEvents', [
    '$rootScope',
    '$q',
    '$log',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').factory('leafletLayerHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
  ...
  angular.module('tripsterApp').factory('leafletControlHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
    'leafletMapDefaults',
  ...
  angular.module('tripsterApp').factory('leafletLegendHelpers', function () {
  ...
  angular.module('tripsterApp').factory('leafletPathsHelpers', [
    '$rootScope',
    '$log',
    'leafletHelpers',
    function ($rootScope, $log, leafletHelpers) {
  ...
  angular.module('tripsterApp').factory('leafletBoundsHelpers', [
    '$log',
    'leafletHelpers',
    function ($log, leafletHelpers) {
  ...
  angular.module('tripsterApp').factory('leafletMarkersHelpers', [
    '$rootScope',
    'leafletHelpers',
    '$log',
  ...
  angular.module('tripsterApp').factory('leafletHelpers', [
    '$q',
    '$log',
    function ($q, $log) {
